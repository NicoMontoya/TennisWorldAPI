...
describe('GET /api/livescore security', () => {
    ...
    it('returns 429 on the 61st request per IP (bucket livescore)', async () => {
        env.TENNIS_CACHE._store.set('_rl:livescore:203.0.113.4', String(RL_PER_MINUTE.max));
        await expectReject(
...
describe('GET /api/hub security', () => {
    ...
    it('returns 429 on the 61st request per IP (bucket hub)', async () => {
